...
export const Image_Values = [
    ...
    { src: `${imageTwo}`, classes: "img img-lg-ctr", altText: "Lone hytte near Amdal.", id: "2", blogEntry: "We went on a hike with our neighbors, Cédrik, Sophie, and their daughter Anna. Came across these awesome hyttas (cabins) at the end of our trek. We unanimously decided to buy one as soon as possible." },
